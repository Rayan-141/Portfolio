...
export const metadata: Metadata = {
  title: "Refund Policy",
  description: "Refund terms for services provided by Rayan.",
  alternates: { canonical: "/refund-policy" },
  openGraph: {
    title: "Refund Policy | Rayan",
    description:
...
export default function RefundPolicyPage() {
  return (
    <PolicyPageClient
      ...
      intro="This Refund Policy applies to services delivered by Rayan through rayan.com and direct client agreements."
      sections={[
        {
        ...
        },
        {
          ...
          content: [
            "Refund requests must be sent in writing to contact@rayan.com with invoice details and a clear reason.",
