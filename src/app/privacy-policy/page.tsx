...
export const metadata: Metadata = {
  ...
  description:
    "Privacy Policy for rayan.com services and communications.",
  alternates: { canonical: "/privacy-policy" },
  openGraph: {
    title: "Privacy Policy | Rayan",
    description:
      "How data is collected, used, and protected on rayan.com.",
...
export default function PrivacyPolicyPage() {
  return (
    <PolicyPageClient
      ...
      intro="This Privacy Policy explains how Rayan collects, uses, and protects information when you use rayan.com and related services."
      sections={[
        {
        ...
        },
        {
          ...
          content: [
            ...
            "For privacy questions, contact: contact@rayan.com.",
          ],
        },
      ]}
    />
