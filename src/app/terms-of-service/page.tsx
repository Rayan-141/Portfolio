...
export const metadata: Metadata = {
  ...
  description: "Professional Terms of Service for services by Rayan.",
  alternates: { canonical: "/terms-of-service" },
  openGraph: {
    title: "Terms of Service | Rayan",
    description:
...
export default function TermsOfServicePage() {
  return (
    <PolicyPageClient
      ...
      intro="These Terms of Service govern access to rayan.com and all consulting, engineering, automation, and product delivery services provided by Rayan."
      sections={[
        {
          title: "Service Scope",
          content: [
        ...
        },
        {
          ...
          content: [
            "Questions regarding these terms can be sent to contact@rayan.com.",
