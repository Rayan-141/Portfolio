...
export const metadata: Metadata = {
  ...
  description:
    "The requested route was not found. Continue browsing Rayan Portfolio v5.",
  alternates: {
    canonical: "/404",
  },
  robots: {
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "404 page for Rayan Portfolio v5",
      },
    ],
  },
  twitter: {
...
export default function NotFoundPage() {
  const notFoundJsonLd = {
    ...
    description: "Custom route-not-found page for Rayan Portfolio v5.",
  };
