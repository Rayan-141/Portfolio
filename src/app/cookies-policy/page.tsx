...
export const metadata: Metadata = {
  ...
  description: "Cookies and tracking technologies policy for rayan.com.",
  alternates: { canonical: "/cookies-policy" },
  openGraph: {
    title: "Cookies Policy | Rayan",
    description:
      "How cookies and analytics technologies are used on rayan.com.",
...
export default function CookiesPolicyPage() {
  return (
    <PolicyPageClient
      ...
      intro="This Cookies Policy explains how cookies and related tracking technologies are used on rayan.com."
      sections={[
        {
        ...
        },
        {
          ...
          content: [
            ...
            "For policy questions, contact: contact@rayan.com.",
          ],
        },
      ]}
    />
