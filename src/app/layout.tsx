...
export const metadata: Metadata = {
  ...
  applicationName: "Rayan Portfolio",
  title: {
    default: "Rayan | Data Scientist & Full Stack Engineer",
    template: "%s | Rayan",
  },
  description:
    "High-converting personal portfolio of Rayan. Data Scientist, Analyst & Full Stack Engineer.",
  alternates: {
    canonical: "/",
  },
  keywords: [
  ...
  twitter: {
    ...
    title: "Rayan",
    description:
      "Data Scientist, Analyst & Full Stack Engineer.",
    images: [ogImageUrl],
    creator: "@rayan_",
  },
};
...
export default function RootLayout({
  ...
  const personJsonLd = {
    ...
    name: "Rayan",
    url: siteUrl,
    jobTitle: "Data Scientist, Analyst & Full Stack Engineer",
    sameAs: [
      githubUrl,
      linkedinUrl,
      xUrl,
  ...
  const websiteJsonLd = {
    ...
    sameAs: [linkHubUrl, rayanDevUrl, sponsorUrl, donationUrl],
    potentialAction: {
      "@type": "SearchAction",
