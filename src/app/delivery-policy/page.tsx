...
export const metadata: Metadata = {
  ...
  description: "Delivery standards and channels for services by Rayan.",
  alternates: { canonical: "/delivery-policy" },
  openGraph: {
    title: "Delivery Policy | Rayan",
...
export default function DeliveryPolicyPage() {
  return (
    <PolicyPageClient
      ...
      intro="This Delivery Policy describes how services and project deliverables are provided by Rayan through remote-first workflows."
      sections={[
        {
          title: "Delivery Mode",
          content: [
