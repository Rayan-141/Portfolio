...
export function Footer() {
  ...
  useEffect(() => {
    ...
    animate(socialTargets, {
      opacity: [0, 1],
      translateY: [10, 0],
      delay: (_: any, index: number) => index * 45,
      duration: 280,
      ease: "outQuad",
    });
    ...
    animate(policyTargets, {
      opacity: [0, 1],
      translateY: [10, 0],
      delay: (_: any, index: number) => 120 + index * 35,
      duration: 280,
      ease: "outQuad",
    });
      ...
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-6 px-4 py-8 text-secondary-foreground lg:flex-row lg:items-start lg:justify-between">
        ...
        <div className="flex w-full flex-col items-center gap-3 lg:w-auto lg:items-end">
          ...
          <div className="flex flex-wrap items-center justify-center gap-2 lg:justify-end">
            <Link href="/" className="retro-link" data-footer-policy>
              Home
            </Link>
            <Link href="/about" className="retro-link" data-footer-policy>
              About
            </Link>
            ...
            <Link href="/certifications" className="retro-link" data-footer-policy>
              Certifications
            </Link>
            <Link href="/education" className="retro-link" data-footer-policy>
              Education
            </Link>
            <Link href="/contact" className="retro-link" data-footer-policy>
              Contact
            </Link>
          </div>
        </div>
